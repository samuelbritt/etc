...
"
"
" Edited by Sam to remove all italics and bold, for better integration with
" fonts that do not support them (like Inconsolata).
...
let colors_name = "macvim_regular"
...
if &background == "dark"
  ...
  hi Comment      gui=NONE guifg=CadetBlue3
...
if has("gui_macvim") && !exists("s:augroups_defined")
  au FocusLost * if exists("colors_name") && colors_name == "macvim_regular" | hi Visual guibg=MacSecondarySelectedControlColor | endif
  au FocusGained * if exists("colors_name") && colors_name == "macvim_regular" | hi Visual guibg=MacSelectedTextBackgroundColor | endif
